...
\begin{abstract}
    ...
    can be installed on every common operating system. It has no graphical user
    interface but runs in a terminal. A new web app of \M2 allows easy
    ...
    Interactive Shell has been used in courses at Cornell
...
We developed a web version of \M2 \cite{M2}. It is available at \cite{webM2}.

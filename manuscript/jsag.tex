...
load this into your {\tt running web.macaulay2.com} session using the {\tt uploadTutorial} button at the bottom of the tutorial list.
You will be prompted for the  html document which the {\tt makeTutorial} script created.
...
or have them download the file.  They then load this tutorial into their {\tt running web.macaulay2.com} session using the {\tt uploadTutorial} button as well.
...
In the case that you don't have access to \M2 on your local machine, you can upload the  {\it SimpleDoc} file to the server, convert it there and then download it using the \M2 {\tt open} function.

...
// this should only be called with url /upload
trym2.uploadCallback = function() {
    return function() {
        ...
        $ajax({
            ...
            contentType: false,
            processData: false,
            sucess: trym2.uploadHandler
        });
        return false;
    };  
};

trym2.uploadHandler = function() {return false;}
